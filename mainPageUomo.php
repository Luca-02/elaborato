      ...
      <div class="hero">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          <div class="header2">
            <nav>
              <ul class="shortcut2">
                <li> <button class="tutti" name="tutti-i-prodotti-uomo"> Tutti i prodotti da Uomo </button> </li>
              </ul>
            </nav>
          </div>
          ...
          <div class="header2 sticky-header">
            <!-- <nav>
              <ul class="shortcut2">
                <li class="container"> <p class="button-uomo click" name="button2-1" title="Abbigliamento"> Abbigliamento </p>
                  <div class="list">
                      <?php
                        ...
                        $sql .= "SELECT IDtipo_calzatura FROM $tipo_calzatura WHERE tipo = 'uomo'))";
                        ...
                        while($row = $result->fetch_assoc()) {
                          echo "<button class='links links-uomo' name=bottone-prodotti value={$row['IDoggetto']}>
                                  {$row['nome_oggetto']}
                                </button>";
                        }
                       ?>
                ...
                <li class="container"> <p class="button-uomo click2" name="button2-1" title="Borse"> Borse </p>
                  <div class="list2">
                      <?php
                        $sql =  "SELECT * FROM $oggetto WHERE idcalzatura_oggetto IN (";
                        $sql .= "SELECT IDcalzatura_oggetto FROM $calzatura_oggetto WHERE idtipo_calzatura IN (";
                ...
                <li class="container"> <p class="button-uomo click3" name="button2-1" title="Calzature"> Calzature </p>
                  <div class="list3">
                      <?php
                        $sql =  "SELECT * FROM $oggetto WHERE idcalzatura_oggetto IN (";
                        $sql .= "SELECT IDcalzatura_oggetto FROM $calzatura_oggetto WHERE idtipo_calzatura IN (";
                ...
                <li class="container"> <p class="button-uomo click4" name="button2-1" title="Accessori"> Accessori </p>
                  <div class="list4">
                      <?php
                        $sql =  "SELECT * FROM $oggetto WHERE idcalzatura_oggetto IN (";
                        $sql .= "SELECT IDcalzatura_oggetto FROM $calzatura_oggetto WHERE idtipo_calzatura IN (";
