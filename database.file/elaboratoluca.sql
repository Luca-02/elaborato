...
INSERT INTO `acquisto` VALUES (37,1,20,27),(38,1,112,28),(39,2,191,28);
...
INSERT INTO `metodo_pagamento` VALUES (15,'Luca','Milanesi','1111-2222-3333-4444',4,2028,123,38,99090.04),(16,'Luca','Milanesi','9999-9999-9999-9999',3,2058,555,38,100000.00),(17,'Mario','Rossi','1212-1212-1212-1212',5,2028,987,39,100000.00),(18,'giorgia','verdi','5555-5555-5555-5555',8,2030,555,46,100000.00),(19,'provaNome','provaCognome','8888-8888-8888-8888',8,2040,888,37,100000.00);
...
CREATE TABLE `ordine` (
  ...
  CONSTRAINT `ordine_ibfk_2` FOREIGN KEY (`idspedizione`) REFERENCES `spedizione` (`IDspedizione`)
...
INSERT INTO `ordine` VALUES (27,'Italia','Milanesi','milanesiluca2002@gmail.com','Via Asiago 55','Milano','Baranzate',20021,'**** **** **** 4444','2021-05-18 00:02:32','123','123','0',149.99,38,1),(28,'Italia','Milanesi','milanesiluca2002@gmail.com','Via Asiago 55','Milano','Baranzate',20021,'**** **** **** 4444','2021-05-18 00:15:49','123','123','0',759.97,38,2);
...
CREATE TABLE `spedizione` (
  ...
  `tipo_spedizione` varchar(20) DEFAULT NULL,
  `costo` decimal(10,2) DEFAULT NULL,
  `giorni_consegna_max` int(11) DEFAULT NULL,
...
INSERT INTO `spedizione` VALUES (1,'normale ',4.99,7),(2,'veloce',14.99,3);
...
-- Dump completed on 2021-05-18  0:43:05
